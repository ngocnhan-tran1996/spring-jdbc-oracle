...
import io.ngocnhan_tran1996.spring.jdbc.oracle.ComplexCustomer;
import io.ngocnhan_tran1996.spring.jdbc.oracle.ComplexCustomerRecord;
...
class ComplexExampleServiceTest extends SetupTestData {
    ...
    void with_type_Record() throws NoSuchMethodException {
        ...
        // arrange
        var address = new ComplexCustomerRecord.Address(
            "district",
            "city",
            List.of("1", "2")
        );
